function [X,h] = plot_violin_scatter(vec,pos,bin,wide,fig)
%PLOT_VIOLIN_SCATTER Rearrange x-axis for scatter plot shaped in a violin plot
%
%   [X,h] = PLOT_VIOLIN_SCATTER(vec,pos,bin,wide,fig)
%
